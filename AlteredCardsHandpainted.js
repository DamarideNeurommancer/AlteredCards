...
var xmlDoc;
var xmlCards=`<Cards><C I="999999" N="Fiverr" U="https://it.fiverr.com/damaride" R=""/></Cards>`;
...
function mySearch(){
 ...
 document.getElementById('totalCards').innerHTML = "<font size='1'>Found " + CardCnt + (CardCnt!=totXmlCards?  " of " + totXmlCards: "") + " Handprinted Cards";
 window.scrollTo(0, 0);
}
