...
var myDetails=document.getElementById('panel1');
 ...
 */ 
 ...
 var detailHTML=`<div id="d1" style="text-align:center;font-size:16px;font-weight:900;color:gold">${title}</div>`;
 ...
 cell.innerHTML=uk;
 */
 detailHTML=`<div id="d2" style="text-align:center;font-size:14px;font-weight:bolder;font-style:italic;color:white">${uk}</div>`;
 myDetails.innerHTML+=detailHTML;
 ...
 */
 detailHTML=`<div id="d3" style="text-align:center;font-size:14px;font-weight:bolder;color:gold">${epzcas}</div>`;
 myDetails.innerHTML+=detailHTML;
...
function initVars(){
 ...
 myDetails=document.getElementById('panel1');
 ...
 */
 ...
 d5.style.borderColor="red";
 var name=document.getElementById("d1").innerText.split('-')[1];
 var upkeyword=document.getElementById("d2").innerText;
 var descr=d5.innerText;
 ...
 if(window.getSelection().containsNode(document.getElementById("d5"),true)){
...
function t2sPauseResume(){
 if(t2sStarted){
  if(t2sPaused){
   ...
   //document.getElementById("myDetails").rows[4].cells[0].style.borderColor="red";
   document.getElementById("d5").style.borderColor="red";
  }
  else{
   ...
   document.getElementById("d5").style.borderColor="green";
   t2sPaused=true;
  }
 }
}
function t2sStop(){
 ...
 try{
  ...
  document.getElementById("d5").style.borderColor="white";
 }
 catch(err){;}
}
